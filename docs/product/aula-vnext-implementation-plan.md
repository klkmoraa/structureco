...
This plan implements slices AULA-A1 through AULA-A8 from [`docs/product/aula-vnext.md`](aula-vnext.md). Retiring persisted prediction fields and creating an editorial content manifest are independent migrations (AULA-A9/A10) and require their own specifications after A1–A8 reach parity.
