...
file mkdir output
recorder Node -file output/S3D-AXIAL-001.disp.out -node 2 -dof 1 2 3 4 5 6 disp
recorder Node -file output/S3D-AXIAL-001.reaction.out -node 1 -dof 1 2 3 4 5 6 reaction
