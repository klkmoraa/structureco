...
El desglose técnico para A1–A8 está en el [plan de implementación](../plans/2026-08-24-aula-vnext-result-explanation.md). Ese plan tampoco autoriza ejecutar los slices dentro de CRI-18.
